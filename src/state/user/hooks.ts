...
export function useUserAddedTokens(): Token[] {
  ...
  // return useMemo(() => {
  //   if (!chainId) return []
  //   return Object.values(serializedTokensMap[chainId as ChainId]).length > 0 ? Object.values(serializedTokensMap[chainId as ChainId]).map(serializedToken => {
  //     return new Token(
  //       serializedToken.chainId,
  //       serializedToken.address,
  //       serializedToken.decimals,
  ...
  //       serializedToken.name
  //     )
  //     // return deserializeToken(newToken)
  //   }) : []
